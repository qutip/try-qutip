...
#### Quantum circuits and algorithms
  ...
  - [QuTiPv5 Paper - Quantum Circuits with QIP](./tutorials/quantum-circuits/v5_paper-qip2.ipynb)
...
#### Pulse-level circuit simulation
  ...
  - [Customize the pulse-level simulation](./tutorials/pulse-level-circuit-simulation/qip-customize-device.ipynb)
...
### Time evolution
  ...
  - [Calculate time propagators with Dysolve](./tutorials/time-evolution/023_dysolve_propagator.ipynb)

  - [QuTiPv5 Paper Example: `sesolve` and `mesolve` and the new solver class](./tutorials/time-evolution/024_v5_paper-mesolve.ipynb)

  - [QuTiPv5 Paper Example: Floquet Speed Test](./tutorials/time-evolution/025_v5_paper-floquet-speed-test.ipynb)

  - [QuTiPv5 Paper Example: Monte Carlo Solver for non-Markovian Baths](./tutorials/time-evolution/026_v5_paper-nm_mcsolve.ipynb)
...
### Miscellaneous tutorials
  ...
  - [Introduction to the Jaynes-Cummings-Hubbard Model: Three-Site System](./tutorials/miscellaneous/JCHM-tutorial.ipynb)

  - [Lecture: Single-photon Interference](./tutorials/miscellaneous/single-photon-interference.ipynb)

  - [QuTiPv5 Paper Example: QuTiP-JAX with mesolve and auto-differnetiation](./tutorials/miscellaneous/v5_paper-jax.ipynb)

  - [QuTiPv5 Paper Example: The Quantum Optimal Control Package](./tutorials/miscellaneous/v5_paper-optimal-control.ipynb)
...
topics and analyze them numerically using QuTiP (some more detailed than others).
  ...
  - [Lecture 13 - Resonance fluorescence](./tutorials/lectures/Lecture-13-Resonance-flourescence.ipynb)
